...
Note: *Follow [Password Security](/getting-started/connection.md) for an information about **Security** popup*.

## Add Server

Follow [Add/Update/Remove Server](/getting-started/connection.md) to add server in Smart MOCA Client.
